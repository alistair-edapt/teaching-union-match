...
function ResultCard({ entry, reasons, rank, isTop, defaultOpen, personalCost }) {
      ...
      <div ref={scrollRef} style={{ maxWidth: 720, margin: "0 auto" }}>
        <div className="card" style={{ padding: 40 }}>
          ...
          <p style={{ fontSize: 17, color: "var(--c-text-muted)", marginBottom: 28, lineHeight: 1.6 }}>
            A short set of questions, around three minutes. No sign-up, no email, no tracking. Your answers stay in your browser.
          </p>
