...
window.QUIZ = (function () {
  ...
  const CORE_QUESTIONS = [
    ...
    // Q2b — personal participation stance
    {
      ...
      subtitle: "You don't have to be a member of the union that calls a strike to take part — non-union members can join a lawful, official strike if they support the cause, and have the same legal protection from dismissal as union members.",
      type: "single",
      randomize: true,
      options: [
        { id: "solidarity",    label: "Join it out of solidarity — even one I voted against or didn't vote in",
          desc: "If colleagues secured a mandate, I'd stand with them on the picket line whether or not I personally backed it.",
          w: { collective: 4, campaigning_wider: 1 } },
        { id: "voted_for_only", label: "Join the strike, but only ones I'd voted for myself",
          desc: "I'll take action when I've backed it, but I wouldn't strike on a mandate I voted against.",
          w: { collective: 2, protection: 1 } },
        { id: "non_member",    label: "I'd join a strike even if I weren't a member of the union that called it",
          desc: "I'd want protection and support from an organisation I trust, but I'd still stand with colleagues striking for a cause I agreed with.",
          w: { collective: 2, apolitical: 1, protection: 1 } },
        { id: "opt_out",       label: "Stay a member, but sit that action out",
          desc: "I'd want the freedom to decide case by case rather than always taking part.",
          w: { collective: 1, protection: 1, apolitical: 1 } },
        { id: "keep_working",  label: "Keep working as normal",
          desc: "I'd prefer to keep teaching, even during action called by my own union.",
          w: { apolitical: 2, protection: 2 } },
        { id: "not_a_union",   label: "I'd rather not be in a union that can call strikes at all",
          desc: "I'd prefer an organisation where this situation simply doesn't arise.",
          w: { apolitical: 3, protection: 2, collective: -2 } },
      ],
    },
    ...
    // Q4 — caseworker vs rep (unchanged)
    {
      ...
      options: [
        ...
        { id: "schoolrep",  label: "An in-school rep",
          ...
          w: { collective: 2, protection: 1 } },
        { id: "either",     label: "Either is fine", anchor: true,
    ...
    // Q7 — involvement (was Q8; kept, with gratuitous apolitical negative removed)
    {
      ...
      options: [
        ...
        { id: "occasional", label: "Occasionally", anchorIndex: 1,
    ...
    {
      id: "political_fund",
      text: "Unions differ in how political they are. How political would you want yours to be?",
      subtitle: "Some are formally affiliated to the Labour Party (e.g. Community, Unite). Others stay independent of any party but campaign on education and workplace policy. Others avoid politics altogether. Many run a \"political fund\" that members can usually opt out of.",
      type: "single",
      randomize: true,
      options: [
        { id: "want_party",   label: "Affiliated to a party — I'd want my union to back political parties that share its goals",
          desc: "Unions should use their collective voice in party politics.",
          w: { party_politics: 3, campaigning_wider: 1 } },
        { id: "policy_not_party", label: "Independent of any party, but campaigning on education and workplace policy",
          desc: "I want a strong campaigning voice, but not one tied to a political party.",
          w: { campaigning_wider: 2, campaigning_education: 1 } },
        { id: "fine_opt_out", label: "Fine with a political fund — but I'd opt out of the levy myself",
        ...
        { id: "no_affiliation", label: "I'd want an organisation with no political affiliation at all",
          desc: "Independence from political parties is a requirement for me.",
          w: { apolitical: 3, party_politics: -3 } },
        { id: "dont_know",    label: "I'd need to learn more before deciding", anchor: true,
  ...
  function detectTensions(answers, rawScores) {
    ...
    //         strike_participation = solidarity, voted_for_only, or non_member, AND
    //         political_fund = avoid_fund or no_affiliation
    const proStrikeRights  = ["fundamental", "concerned"].includes(answers.strike_rights);
    const proStrikeAction  = ["solidarity", "voted_for_only", "non_member"].includes(answers.strike_participation);
