...
window.ORGS = {
  neu: {
    ...
    considerations: [
      ...
      "The teaching union most willing to call for industrial action",
      "Front-line support often comes from volunteer reps balancing it with their own teaching job, so availability and expertise can vary from school to school.",
  ...
  nasuwt: {
    ...
    description:
      "A specialist teachers' union that has roots dating back to 1976 and has entities covering all four UK nations. Focuses on workplace rights, pay and conditions. It has often been seen as less broad-based than the NEU because it represents qualified teachers rather than the wider education workforce, but it remains willing to campaign and take industrial action where it believes members' interests require it.",
    strengths: [
    ...
    considerations: [
      ...
      "Has at times taken a different position from the NEU on industrial action, so teachers in the same school may find the two unions are not always aligned",
      "Front-line support often comes from local reps and officers balancing it with their own jobs, so availability and expertise can vary by area",
  ...
  edapt: {
    ...
    strengths: [
      "Support comes from professional caseworkers rather than volunteer reps — a consistent, centralised service.",
      ...
      "Focuses solely on individual casework rather than campaigning, so tends to be among the lowest-cost options",
      "Independent public reviews of its member support are consistently strong",
    ],
    considerations: [
  ...
  ascl: {
    ...
    description:
      "It describes itself as representing more than 25,000 leaders across primary, secondary, post-16, college and trust settings, and says it has no political affiliation. ASCL is often perceived as policy-focused and professionally oriented, with a strong emphasis on national education policy, leadership advice, member support and professional development. Covers England, Wales and Northern Ireland. History dating back to 1874.",
    strengths: [
      ...
      "Professional caseworkers and a national support line rather than in-school reps",
  ...
  naht: {
    ...
    description:
      "A trade union and professional association for school leaders, particularly headteachers, deputy heads, assistant heads, school business leaders and other senior leaders. It represents more than 28,500 members across England, Wales and Northern Ireland, with membership spanning early years, primary, special, secondary, independent, sixth form, FE and other educational settings. It tends to focus on leadership conditions, accountability, inspection, funding, workload, recruitment and the practical realities of running schools. It is affiliated to the TUC. Long history going back to 1897.",
    strengths: [
  ...
  community: {
    ...
    description:
      "A general trade union that has political links to the Labour Party. Represents workers in a variety of industries including steelworkers, garment workers and social work employees. 'Voice' a former specialist education union known for its independence and non-striking policy transferred to become part of Community in 2020.",
    strengths: [
      "Broad education and early years coverage",
      "One union covering teachers, leaders and support staff together — useful where a whole staffroom wants the same organisation",
  ...
  unison: {
    ...
    strengths: [
      ...
      "Recognised beyond schools in other workplaces",
      "Part of the National Joint Council that helps to negotiate pay for local authority support staff",
    ],
    considerations: [
      "Support staff only",
