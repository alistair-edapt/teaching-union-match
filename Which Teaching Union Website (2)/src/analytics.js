...
*/
(function () {
  const GA_ID = "G-XXXXXXXXXX"; // placeholder — swap for real GA4 measurement ID
    ...
    el.innerHTML = `
      <div class="wtu-consent-inner">
        <div class="wtu-consent-copy">
          <strong>We'd like to count how many people use this tool.</strong>
          <span>No personal data, no tracking across sites — just an anonymous count via Google Analytics so we can make it better.</span>
        </div>
  ...
  const css = `
    ...
    #wtu-consent .wtu-consent-accept { background: var(--c-primary, #5A2C7A); border-color: var(--c-primary, #5A2C7A); color: #fff; }
